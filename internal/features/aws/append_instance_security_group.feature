...
Feature: Service apply
  ...
  Scenario: Append security group to an instance
    ...
    And all "instance.update.aws-fake" messages should contain a field "vpc_id" with "fakeaws"
    And message "instance.update.aws-fake" number "0" should contain "null" as json field "security_group_aws_ids.0"
    And message "instance.update.aws-fake" number "0" should contain "fakeaws-$(name)-web-1" as json field "name"
    And all "instance.update.aws-fake" messages should contain a field "image" with "ami-6666f915"
    And all "instance.update.aws-fake" messages should contain a field "instance_provider" with "e1.micro"
    And all "instance.update.aws-fake" messages should contain a field "status" with "processing"
