...
Feature: Service apply
  ...
  Scenario: Adding rds instances
    ...
    And all "rds_instance.create.aws-fake" messages should contain a field "_type" with "aws-fake"
    ...
    And all "rds_instance.create.aws-fake" messages should contain a field "name" with "fakeaws-$(name)-test-1"
    And all "rds_instance.create.aws-fake" messages should contain a field "size" with "db.r3.large"
    And all "rds_instance.create.aws-fake" messages should contain a field "cluster" with "fakeaws-$(name)-aurora"
