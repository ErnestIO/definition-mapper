...
Feature: Service apply
  ...
  Scenario: Updating rds clusters
    ...
    And all "rds_cluster.update.aws-fake" messages should contain a field "_type" with "aws-fake"
    ...
    And all "rds_cluster.update.aws-fake" messages should contain a field "name" with "fakeaws-$(name)-aurora"
