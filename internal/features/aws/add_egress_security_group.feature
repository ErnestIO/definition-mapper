...
Feature: Service apply
  ...
  Scenario: Add engress security group to a instance
    ...
    And all "firewall.update.aws-fake" messages should contain a field "name" with "fakeaws-$(name)-web-sg-1"
    ...
    And message "firewall.update.aws-fake" number "0" should contain "processing" as json field "status"
