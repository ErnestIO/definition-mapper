...
Feature: Service apply
  ...
  Scenario: Updating rds instances
    ...
    And all "rds_instance.delete.aws-fake" messages should contain a field "_type" with "aws-fake"
    ...
    And all "rds_instance.delete.aws-fake" messages should contain a field "name" with "fakeaws-$(name)-test-1"
    And all "rds_instance.delete.aws-fake" messages should contain a field "size" with "db.r3.xlarge"
    And all "rds_instance.delete.aws-fake" messages should contain a field "cluster" with "fakeaws-$(name)-aurora"
