...
Feature: Service apply
  ...
  Scenario: Removing a network and its asociated instances
    ...
    And all "network.delete.aws-fake" messages should contain a field "_type" with "aws-fake"
    ...
    And all "instance.delete.aws-fake" messages should contain a field "_type" with "aws-fake"
    ...
    And all "instance.delete.aws-fake" messages should contain a field "vpc_id" with "fakeaws"
    And message "instance.delete.aws-fake" number "0" should contain "null" as json field "security_group_aws_ids.0"
    And all "instance.delete.aws-fake" messages should contain a field "name" with "fakeaws-$(name)-bknd-1"
    ...
    And all "instance.delete.aws-fake" messages should contain a field "status" with "processing"
