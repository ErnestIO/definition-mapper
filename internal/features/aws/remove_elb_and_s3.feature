...
Feature: Service apply
  ...
  Scenario: delete an elb and an s3
    ...
    And all "elb.delete.aws-fake" messages should contain a field "_type" with "aws-fake"
    ...
    And all "elb.delete.aws-fake" messages should contain a field "vpc_id" with "fakeaws"
    And all "elb.delete.aws-fake" messages should contain a field "name" with "fakeaws-$(name)-elb-1"
    And message "elb.delete.aws-fake" number "0" should contain "fakeaws-$(name)-web-1" as json field "instance_names.0"
    ...
    And all "s3.delete.aws-fake" messages should contain a field "_type" with "aws-fake"
