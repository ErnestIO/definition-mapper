...
// MapSecurityGroups ...
func MapSecurityGroups(d *definition.Definition, rg *components.ResourceGroup) (sgs []*components.SecurityGroup) {
...
func MapDefinitionSecurityGroups(g *graph.Graph) (sgs []definition.SecurityGroup) {
